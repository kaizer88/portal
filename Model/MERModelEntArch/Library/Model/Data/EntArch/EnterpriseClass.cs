...
{ 
  public class EnterpriseClass : DataObjectHandler 
  { 
    ...
    private const string _SQL_SET_PROCEDURE_NAME = "setEnterpriseClass"; 
    private const string _SQL_GET_PROCEDURE_NAME = "getEnterpriseClass"; 
    ...
    public EnterpriseClass(int ID, string Code, string Description) 
    { 
      _ID = ID; 
      _Code = Code; 
    ...
    public void SetEnterpriseClass(int ID, string Code, string Description) 
    { 
      _ID = ID; 
      _Code = Code; 
      _Description = Description; 
    ...
    { 
      ...
      { 
        case "INSERT": 
          base.SetParameterObject(Action, _ID, _ParentID, _Handle, _Code, _Description, _Definition, _ActionUser, _AuditLog); 
          break; 
        case "UPDATE": 
          goto case "INSERT"; 
        case "DELETE": 
        ...
        case "UNDELETE": 
          goto case "INSERT"; 
        case "LISTOFVALUES": 
          base.SetParameterObject(Action, _ID, _ParentID, _Handle, _Code, _Description, _AuditLog); 
          break; 
        case "LISTITEM": 
